...
import type { Vehicle, Job, VehicleJob, Rate } from '@/lib/types';
                        ...
                        <CardContent className="p-2 flex-1 flex flex-col gap-2 overflow-hidden">
                            <div className="px-4 pb-2 space-y-3">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                                    ...
                                    <Select value={vehicleTypeFilter} onValueChange={setVehicleTypeFilter}><SelectTrigger className="h-9"><SelectValue placeholder="All Vehicle Types" /></SelectTrigger><SelectContent><SelectItem value="all">All Vehicle Types</SelectItem>{vehicleTypes.map(vt => <SelectItem key={vt} value={vt.toLowerCase()}>{vt}</SelectItem>)}</SelectContent></Select>
