...
import { Loader2, ShieldCheck, ShieldOff, Copy, User, Users, Lock, Database, FileDown, Palette } from 'lucide-react';
...
export default function SettingsPage() {
  ...
  const hasProfileChanged = userProfile && (firstName !== (userProfile.firstName || '') || lastName !== (userProfile.lastName || '') || email !== (userProfile.email || ''));
          ...
          <TabsContent value="profile">
            <Card>
              ...
              <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="space-y-1.5"><Label>Role</Label><Input value={userProfile?.role || 'N/A'} disabled /></div>
