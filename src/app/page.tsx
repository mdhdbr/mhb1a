    ...
    <div className="bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="text-center py-20 lg:py-32">
          <h1 className="text-4xl lg:text-6xl font-extrabold tracking-tight font-headline">
        ...
        <section className="py-24 bg-secondary -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8">
        ...
        <section className="py-24">
            ...
            <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                {stats.map(stat => (
                    <div key={stat.label}>
                        <p className="text-5xl lg:text-6xl font-bold text-primary font-headline">{stat.value}</p>
