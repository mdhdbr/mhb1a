...
export default function Header() {
  ...
  const handleSignOut = async () => {
    ...
    const userName = userProfile?.firstName ? `${userProfile.firstName} ${userProfile.lastName}` : user.email || 'User';
    ...
    // Explicitly set user status to offline before signing out
